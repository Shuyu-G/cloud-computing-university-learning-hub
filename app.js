...
const EXTRA_UI_TEXT_TRANSLATIONS = {
  zh: {
    ...
    "Accounts with teaching privileges": "具备教学权限的账户",
    "Learners enrolled into courses": "已选课的学生",
    "Courses available across the platform": "平台中的课程总数",
    "Teacher or student sessions active in the last 5 minutes": "最近 5 分钟在线的教师或学生会话",
    Accounts: "账户",
    Name: "姓名",
    Username: "用户名",
    Role: "角色",
    ...
    Action: "操作",
    Teaching: "教学",
    "Courses you own or manage": "你拥有或管理的课程",
    "Recent posts across your teaching spaces": "你的教学空间中的最新发布",
    "Announcement feed": "公告动态",
    "Audit trail": "审计记录",
    "Enrolled courses": "已选课程",
    "Courses currently assigned to you": "当前分配给你的课程",
    "Recent notices from your teachers": "来自教师的最新通知",
    "Grades posted": "已发布成绩",
    "Courses where a grade is already recorded": "已记录成绩的课程",
    "Next session": "下一次课程",
    "Update the course profile": "更新课程资料",
    Title: "标题",
    "Save course details": "保存课程信息",
    "Add students to this course": "向本课程添加学生",
    "Use manual selection, import a roster CSV, or batch unenroll students with an email list.":
      "使用手动选择、导入名单 CSV，或通过邮箱列表批量退课。",
    "CSV file": "CSV 文件",
    Roster: "名单",
    "Monitor current presence and export the roster for offline review.":
      "查看当前在线状态，并导出名单供线下查看。",
    "Export roster CSV": "导出名单 CSV",
    Gradebook: "成绩册",
    "Save one grade manually or import a gradebook CSV with email, grade, and feedback columns.":
      "手动保存单个成绩，或导入包含邮箱、成绩和反馈列的成绩 CSV。",
    "Export grades CSV": "导出成绩 CSV",
    "Upload courseware to S3": "上传课件到 S3",
    "Display title": "显示标题",
    "Publish a notice": "发布通知",
    "Assessment builder": "测验构建器",
    "Quiz title": "测验标题",
    "Question text": "题目内容",
    "Option A": "选项 A",
    "Option B": "选项 B",
    ...
    "Option D": "选项 D",
    "Correct option": "正确选项",
    "Add another question": "添加另一道题",
    "Original file": "原始文件",
    "Uploaded by": "上传者",
    Uploaded: "上传时间",
    "Assignment workflow": "作业流程",
    "Open an assignment to upload your file to S3 and review grades and feedback saved in RDS.":
      "打开作业以上传文件到 S3，并查看保存在 RDS 中的成绩与反馈。",
    "Public discussion messages stay in RDS and optional attachments are stored in S3.":
      "公共讨论消息保存在 RDS，可选附件存储在 S3。",
    "Course outcome": "课程结果",
    "Upload to cloud storage": "上传到云存储",
    "Your file is uploaded to S3. The submission timestamp, grade, and feedback are kept in RDS.":
      "你的文件会上传到 S3，提交时间、成绩和反馈保存在 RDS。",
    "Replace submission": "替换提交",
    "Download my file": "下载我的文件",
    "Feedback from the teaching team": "教学团队反馈",
    "Back to assignments": "返回作业列表",
    Assignment: "作业",
    Code: "代码",
    Activity: "活动",
    Status: "状态",
    ...
    Quiz: "测验",
    Updated: "更新时间",
    "You do not manage any courses yet.": "你目前还没有管理任何课程。",
    "You are not enrolled in any courses yet.": "你目前还没有选修任何课程。",
    "Quiz overview": "测验概览",
  },
  de: {
    ...
    "Accounts with teaching privileges": "Konten mit Lehrberechtigung",
    "Learners enrolled into courses": "In Kurse eingeschriebene Lernende",
    "Courses available across the platform": "Auf der Plattform verfügbare Kurse",
    "Teacher or student sessions active in the last 5 minutes": "Lehrenden- oder Studierenden-Sitzungen der letzten 5 Minuten",
    Accounts: "Konten",
    Name: "Name",
    ...
    Action: "Aktion",
    Teaching: "Lehre",
    "Courses you own or manage": "Kurse, die Sie besitzen oder verwalten",
    "Recent posts across your teaching spaces": "Neueste Beiträge in Ihren Lehrbereichen",
    "Announcement feed": "Ankündigungsfeed",
    "Audit trail": "Prüfprotokoll",
    "Enrolled courses": "Eingeschriebene Kurse",
    "Courses currently assigned to you": "Derzeit Ihnen zugewiesene Kurse",
    "Recent notices from your teachers": "Aktuelle Hinweise Ihrer Lehrenden",
    "Grades posted": "Veröffentlichte Noten",
    "Courses where a grade is already recorded": "Kurse mit bereits erfasster Note",
    "Next session": "Nächste Sitzung",
    "Update the course profile": "Kursprofil aktualisieren",
    Title: "Titel",
    "Save course details": "Kursdetails speichern",
    "Add students to this course": "Studierende zu diesem Kurs hinzufügen",
    "Use manual selection, import a roster CSV, or batch unenroll students with an email list.":
      "Manuelle Auswahl verwenden, eine Teilnehmerliste als CSV importieren oder Studierende per E-Mail-Liste gesammelt abmelden.",
    "CSV file": "CSV-Datei",
    Roster: "Teilnehmerliste",
    "Monitor current presence and export the roster for offline review.":
      "Aktuelle Anwesenheit überwachen und die Liste für die Offline-Prüfung exportieren.",
    "Export roster CSV": "Teilnehmerliste als CSV exportieren",
    Gradebook: "Notenbuch",
    "Save one grade manually or import a gradebook CSV with email, grade, and feedback columns.":
      "Eine Note manuell speichern oder ein Notenbuch-CSV mit E-Mail-, Noten- und Feedbackspalten importieren.",
    "Export grades CSV": "Noten als CSV exportieren",
    "Upload courseware to S3": "Kursmaterial in S3 hochladen",
    "Display title": "Angezeigter Titel",
    "Publish a notice": "Hinweis veröffentlichen",
    "Assessment builder": "Bewertungseditor",
    ...
    "Assignment workflow": "Abgabe-Workflow",
    "Open an assignment to upload your file to S3 and review grades and feedback saved in RDS.":
      "Öffnen Sie eine Abgabe, um Ihre Datei in S3 hochzuladen und die in RDS gespeicherten Noten und Rückmeldungen zu prüfen.",
    "Public discussion messages stay in RDS and optional attachments are stored in S3.":
      "Öffentliche Diskussionsnachrichten bleiben in RDS, optionale Anhänge werden in S3 gespeichert.",
    "Course outcome": "Kursergebnis",
    "Upload to cloud storage": "In den Cloud-Speicher hochladen",
    "Your file is uploaded to S3. The submission timestamp, grade, and feedback are kept in RDS.":
      "Ihre Datei wird in S3 hochgeladen. Abgabezeit, Note und Feedback werden in RDS gespeichert.",
    "Replace submission": "Abgabe ersetzen",
    "Download my file": "Meine Datei herunterladen",
    "Feedback from the teaching team": "Feedback des Lehrteams",
    "Back to assignments": "Zurück zu den Abgaben",
    Assignment: "Abgabe",
    Code: "Code",
    Activity: "Aktivität",
    Status: "Status",
    "Last seen": "Zuletzt gesehen",
    "My submission": "Meine Einreichung",
    Grading: "Bewertung",
    Submitted: "Abgegeben",
    Score: "Punktzahl",
    Quiz: "Quiz",
    Updated: "Aktualisiert",
    "You do not manage any courses yet.": "Sie verwalten derzeit noch keine Kurse.",
    "You are not enrolled in any courses yet.": "Sie sind derzeit in keinen Kursen eingeschrieben.",
    "Quiz overview": "Quiz-Überblick",
  },
  fr: {
    "Admin Dashboard": "Tableau administrateur",
    Admin: "Admin",
    Teacher: "Enseignant",
    Student: "Étudiant",
    "System Administrator": "Administrateur système",
    "Accounts with teaching privileges": "Comptes avec droits d'enseignement",
    "Learners enrolled into courses": "Étudiants inscrits aux cours",
    "Courses available across the platform": "Cours disponibles sur la plateforme",
    "Teacher or student sessions active in the last 5 minutes": "Sessions enseignant ou étudiant actives durant les 5 dernières minutes",
    Accounts: "Comptes",
    Name: "Nom",
    ...
    "Courses you own or manage": "Cours que vous possédez ou gérez",
    "Recent posts across your teaching spaces": "Publications récentes dans vos espaces d'enseignement",
    "Announcement feed": "Flux d'annonces",
    "Audit trail": "Journal d'audit",
    "Enrolled courses": "Cours suivis",
    "Courses currently assigned to you": "Cours qui vous sont actuellement attribués",
    "Recent notices from your teachers": "Derniers avis de vos enseignants",
    "Grades posted": "Notes publiées",
    "Courses where a grade is already recorded": "Cours avec une note déjà enregistrée",
    "Next session": "Prochaine séance",
    "Update the course profile": "Mettre à jour le profil du cours",
    Title: "Titre",
    "Save course details": "Enregistrer les détails du cours",
    "Add students to this course": "Ajouter des étudiants à ce cours",
    "Use manual selection, import a roster CSV, or batch unenroll students with an email list.":
      "Utilisez une sélection manuelle, importez une liste en CSV ou désinscrivez des étudiants en lot via une liste d'e-mails.",
    "CSV file": "Fichier CSV",
    Roster: "Liste",
    "Monitor current presence and export the roster for offline review.":
      "Suivez la présence actuelle et exportez la liste pour une vérification hors ligne.",
    "Export roster CSV": "Exporter la liste en CSV",
    Gradebook: "Carnet de notes",
    "Save one grade manually or import a gradebook CSV with email, grade, and feedback columns.":
      "Enregistrez une note manuellement ou importez un CSV de notes avec les colonnes e-mail, note et retour.",
    "Export grades CSV": "Exporter les notes en CSV",
    "Upload courseware to S3": "Téléverser les supports vers S3",
    "Display title": "Titre affiché",
    "Publish a notice": "Publier un avis",
    "Assessment builder": "Créateur d'évaluation",
    ...
    "Assignment workflow": "Flux de travail des devoirs",
    "Open an assignment to upload your file to S3 and review grades and feedback saved in RDS.":
      "Ouvrez un devoir pour téléverser votre fichier vers S3 et consulter les notes et retours enregistrés dans RDS.",
    "Public discussion messages stay in RDS and optional attachments are stored in S3.":
      "Les messages de discussion publique restent dans RDS et les pièces jointes facultatives sont stockées dans S3.",
    "Course outcome": "Résultat du cours",
    "Upload to cloud storage": "Téléverser vers le stockage cloud",
    "Your file is uploaded to S3. The submission timestamp, grade, and feedback are kept in RDS.":
      "Votre fichier est téléversé vers S3. L'horodatage, la note et le retour sont conservés dans RDS.",
    "Replace submission": "Remplacer le dépôt",
    "Download my file": "Télécharger mon fichier",
    "Feedback from the teaching team": "Retour de l'équipe pédagogique",
    "Back to assignments": "Retour aux devoirs",
    Assignment: "Devoir",
    Code: "Code",
    Activity: "Activité",
    Status: "Statut",
    "Last seen": "Vu pour la dernière fois",
    "My submission": "Mon dépôt",
    Grading: "Notation",
    Submitted: "Remis",
    Score: "Score",
    Quiz: "Quiz",
    Updated: "Mis à jour",
    "You do not manage any courses yet.": "Vous ne gérez encore aucun cours.",
    "You are not enrolled in any courses yet.": "Vous n'êtes encore inscrit à aucun cours.",
  ...
  hi: {
    ...
    Teacher: "शिक्षक",
    Student: "छात्र",
    "System Administrator": "सिस्टम एडमिनिस्ट्रेटर",
    "Accounts with teaching privileges": "शिक्षण अधिकार वाले खाते",
    "Learners enrolled into courses": "कोर्स में नामांकित विद्यार्थी",
    "Courses available across the platform": "प्लेटफ़ॉर्म पर उपलब्ध कोर्स",
    "Teacher or student sessions active in the last 5 minutes": "पिछले 5 मिनट में सक्रिय शिक्षक या छात्र सत्र",
    Accounts: "अकाउंट",
    Name: "नाम",
    Username: "यूज़रनेम",
    Role: "भूमिका",
    ...
    Action: "कार्रवाई",
    Teaching: "शिक्षण",
    "Courses you own or manage": "वे कोर्स जिन्हें आप संचालित करते हैं",
    "Recent posts across your teaching spaces": "आपके शिक्षण क्षेत्रों की हाल की पोस्ट",
    "Announcement feed": "घोषणा फ़ीड",
    "Audit trail": "ऑडिट ट्रेल",
    "Enrolled courses": "नामांकित कोर्स",
    "Courses currently assigned to you": "वे कोर्स जो अभी आपको सौंपे गए हैं",
    "Recent notices from your teachers": "आपके शिक्षकों की हाल की सूचनाएँ",
    "Grades posted": "पोस्ट किए गए ग्रेड",
    "Courses where a grade is already recorded": "वे कोर्स जिनमें ग्रेड पहले से दर्ज है",
    "Next session": "अगला सत्र",
    "Update the course profile": "कोर्स प्रोफ़ाइल अपडेट करें",
    Title: "शीर्षक",
    "Save course details": "कोर्स विवरण सहेजें",
    "Add students to this course": "इस कोर्स में छात्र जोड़ें",
    "Use manual selection, import a roster CSV, or batch unenroll students with an email list.":
      "मैन्युअल चयन करें, रोस्टर CSV आयात करें, या ईमेल सूची से एक साथ छात्रों को हटाएँ।",
    "CSV file": "CSV फ़ाइल",
    Roster: "रोस्टर",
    "Monitor current presence and export the roster for offline review.":
      "मौजूदा उपस्थिति देखें और ऑफ़लाइन समीक्षा के लिए रोस्टर निर्यात करें।",
    "Export roster CSV": "रोस्टर CSV निर्यात करें",
    Gradebook: "ग्रेडबुक",
    "Save one grade manually or import a gradebook CSV with email, grade, and feedback columns.":
      "एक ग्रेड मैन्युअल रूप से सहेजें या ईमेल, ग्रेड और फ़ीडबैक कॉलम वाला ग्रेडबुक CSV आयात करें।",
    "Export grades CSV": "ग्रेड CSV निर्यात करें",
    "Upload courseware to S3": "कोर्स सामग्री S3 पर अपलोड करें",
    "Display title": "दिखाई जाने वाली शीर्षक",
    "Publish a notice": "सूचना प्रकाशित करें",
    "Assessment builder": "असेसमेंट बिल्डर",
    "Quiz title": "क्विज़ शीर्षक",
    ...
    "Add another question": "एक और प्रश्न जोड़ें",
    "Original file": "मूल फ़ाइल",
    "Uploaded by": "अपलोड करने वाला",
    Uploaded: "अपलोड समय",
    "Assignment workflow": "असाइनमेंट वर्कफ़्लो",
    "Open an assignment to upload your file to S3 and review grades and feedback saved in RDS.":
      "अपनी फ़ाइल S3 पर अपलोड करने और RDS में सहेजे गए ग्रेड व फ़ीडबैक देखने के लिए असाइनमेंट खोलें।",
    "Public discussion messages stay in RDS and optional attachments are stored in S3.":
      "सार्वजनिक चर्चा संदेश RDS में रहते हैं और वैकल्पिक संलग्नक S3 में संग्रहीत होते हैं।",
    "Course outcome": "कोर्स परिणाम",
    "Upload to cloud storage": "क्लाउड स्टोरेज पर अपलोड करें",
    "Your file is uploaded to S3. The submission timestamp, grade, and feedback are kept in RDS.":
      "आपकी फ़ाइल S3 पर अपलोड होती है। सबमिशन समय, ग्रेड और फ़ीडबैक RDS में रखे जाते हैं।",
    "Replace submission": "सबमिशन बदलें",
    "Download my file": "मेरी फ़ाइल डाउनलोड करें",
    "Feedback from the teaching team": "शिक्षण टीम से फ़ीडबैक",
    "Back to assignments": "असाइनमेंट पर वापस जाएँ",
    Assignment: "असाइनमेंट",
    Code: "कोड",
    Activity: "गतिविधि",
    Status: "स्थिति",
    "Last seen": "आख़िरी बार देखा गया",
    "My submission": "मेरा सबमिशन",
    Grading: "मूल्यांकन",
    Submitted: "जमा किया गया",
    Score: "स्कोर",
    Quiz: "क्विज़",
    Updated: "अपडेट किया गया",
    "You do not manage any courses yet.": "आप अभी कोई कोर्स प्रबंधित नहीं कर रहे हैं।",
    "You are not enrolled in any courses yet.": "आप अभी किसी भी कोर्स में नामांकित नहीं हैं।",
    "Quiz overview": "क्विज़ सारांश",
  },
  ar: {
    ...
    "Accounts with teaching privileges": "حسابات تملك صلاحيات التدريس",
    "Learners enrolled into courses": "الطلاب المسجلون في المقررات",
    "Courses available across the platform": "المقررات المتاحة على المنصة",
    "Teacher or student sessions active in the last 5 minutes": "جلسات المعلمين أو الطلاب النشطة خلال آخر 5 دقائق",
    Accounts: "الحسابات",
    Name: "الاسم",
    ...
    Action: "الإجراء",
    Teaching: "التدريس",
    "Courses you own or manage": "المقررات التي تملكها أو تديرها",
    "Recent posts across your teaching spaces": "أحدث المنشورات في مساحاتك التعليمية",
    "Announcement feed": "سجل الإعلانات",
    "Audit trail": "سجل التدقيق",
    "Enrolled courses": "المقررات المسجل بها",
    "Courses currently assigned to you": "المقررات المسندة إليك حالياً",
    "Recent notices from your teachers": "أحدث الإشعارات من معلميك",
    "Grades posted": "الدرجات المنشورة",
    "Courses where a grade is already recorded": "المقررات التي تم تسجيل درجة فيها بالفعل",
    "Next session": "الجلسة القادمة",
    "Update the course profile": "تحديث ملف المقرر",
    Title: "العنوان",
    "Save course details": "حفظ تفاصيل المقرر",
    "Add students to this course": "إضافة طلاب إلى هذا المقرر",
    "Use manual selection, import a roster CSV, or batch unenroll students with an email list.":
      "استخدم التحديد اليدوي، أو استورد قائمة CSV، أو ألغِ تسجيل الطلاب دفعة واحدة عبر قائمة بريد إلكتروني.",
    "CSV file": "ملف CSV",
    Roster: "القائمة",
    "Monitor current presence and export the roster for offline review.":
      "تابع الحضور الحالي وصدّر القائمة للمراجعة دون اتصال.",
    "Export roster CSV": "تصدير القائمة CSV",
    Gradebook: "سجل الدرجات",
    "Save one grade manually or import a gradebook CSV with email, grade, and feedback columns.":
      "احفظ درجة واحدة يدوياً أو استورد ملف درجات CSV يحتوي على البريد الإلكتروني والدرجة والملاحظات.",
    "Export grades CSV": "تصدير الدرجات CSV",
    "Upload courseware to S3": "رفع ملفات المقرر إلى S3",
    "Display title": "العنوان الظاهر",
    "Publish a notice": "نشر إشعار",
    "Assessment builder": "منشئ التقييم",
    "Quiz title": "عنوان الاختبار القصير",
    ...
    "Assignment workflow": "سير عمل الواجبات",
    "Open an assignment to upload your file to S3 and review grades and feedback saved in RDS.":
      "افتح واجباً لرفع ملفك إلى S3 ومراجعة الدرجات والملاحظات المحفوظة في RDS.",
    "Public discussion messages stay in RDS and optional attachments are stored in S3.":
      "تبقى رسائل النقاش العامة في RDS وتُخزن المرفقات الاختيارية في S3.",
    "Course outcome": "نتيجة المقرر",
    "Upload to cloud storage": "الرفع إلى التخزين السحابي",
    "Your file is uploaded to S3. The submission timestamp, grade, and feedback are kept in RDS.":
      "يُرفع ملفك إلى S3، بينما يتم حفظ وقت التسليم والدرجة والملاحظات في RDS.",
    "Replace submission": "استبدال التسليم",
    "Download my file": "تنزيل ملفي",
    "Feedback from the teaching team": "ملاحظات فريق التدريس",
    "Back to assignments": "العودة إلى الواجبات",
    Assignment: "واجب",
    Code: "الرمز",
    Activity: "النشاط",
    Status: "الحالة",
    "Last seen": "آخر ظهور",
    "My submission": "تسليمي",
    Grading: "التقييم",
    Submitted: "تم التسليم",
    Score: "النتيجة",
    Quiz: "اختبار قصير",
    Updated: "آخر تحديث",
    "You do not manage any courses yet.": "أنت لا تدير أي مقررات حتى الآن.",
    "You are not enrolled in any courses yet.": "أنت غير مسجل في أي مقرر حتى الآن.",
    "Quiz overview": "نظرة عامة على الاختبار",
  },
};

for (const [locale, entries] of Object.entries(EXTRA_UI_TEXT_TRANSLATIONS)) {
  Object.assign(UI_TEXT_TRANSLATIONS[locale], entries);
}
            ...
            },
            {
              ...
              render: function (_, count) {
                return {
                  ...
                  de: 'Master (' + count + ')',
                  fr: 'Master (' + count + ')',
                  hi: 'स्नातकोत्तर (' + count + ')',
                  ar: 'دراسات عليا (' + count + ')',
                }[locale];
              },
            },
            {
              regex: /^(Undergraduate|Graduate) · (.+)$/,
              render: function (_, level, program) {
                const localizedLevel = localizeFragment(level, locale);
                return localizedLevel + ' · ' + program;
              },
            },
            {
              regex: /^Questions: (\d+)$/,
